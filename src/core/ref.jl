function _get_power_conversion_factor(pwm::AbstractPowerWaterModel; nw::Int = _IM.nw_id_default)::Float64
    ...
    base_power_pmd = 1.0e-6 / base_mva_pmd # Watts per PM unit.
    ...
    base_power_wm = transform_mass(1.0) * transform_length(1.0)^2 / transform_time(1.0)^3

    # Return the power conversion factor for pumps.
    return base_power_wm / base_power_pmd
end